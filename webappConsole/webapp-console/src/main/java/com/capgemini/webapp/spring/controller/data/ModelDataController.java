...
public class ModelDataController {
	...
	public ResponseEntity<List<CategoryModel>> getCategoryDetail(@RequestParam(value="subMenuId") String subMenuId, @RequestParam(value="busiTypeId") String busiTypeId) {
