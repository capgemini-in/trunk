...
import com.capgemini.webapp.security.config.JAASUserPrincipal;

@Component
public class CustomJaasLoginModule implements LoginModule, ApplicationContextAware {
	...
	public void initialize(Subject subject, CallbackHandler callbackHandler, Map<String, ?> sharedState,
		...
		System.out.println(" initialize Context Initialised :" + context.getApplicationName());
		succeeded = false;
	}
	...
	public boolean login() throws LoginException {
		...
		String[] beansArray = context.getBeanDefinitionNames();
		int i = 0;
		...
		PasswordEncoder passwordEncoder = context.getBean("passwordEncoder", BCryptPasswordEncoder.class);
		UserDetailsService userDetailsService = context.getBean("customUserDetailsService", UserDetailsService.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		System.out.println(" Context Initialised :" + context.getApplicationName());
	}
